        ...
        .config(function ($stateProvider, $urlRouterProvider, $ionicConfigProvider, $httpProvider) {
            ...
            $stateProvider
                    ...
                    .state('app.schedule-video-broadcast', {
                     ...
                     .state('app.create-mystyle-test', {
                        cache: false,
                        url: "/create-mystyle-test",
                        views: {
                            'menuContent': {
                                templateUrl: "views/app/create-mystyle-test.html",
                                controller: 'createMystyleTestCtrl'
                            }
                        }
                    })                    
                    ;
            ...
            $urlRouterProvider.otherwise('/app/create-mystyle-test');
        });
